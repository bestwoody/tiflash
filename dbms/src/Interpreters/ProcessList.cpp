    ...
    const Settings & settings)
{
...

    {
        ...
        res = std::make_shared<Entry>(*this, cont.emplace(cont.end(), query_, client_info, settings.max_memory_usage, settings.memory_tracker_fault_probability, settings.memory_tracker_accuracy_diff, priorities.insert(settings.priority)));
