...
public:
    ProcessListElement(
        ...
        size_t memory_tracker_accuracy_diff_for_test,
        ...
        , priority_handle(std::move(priority_handle_))
    {
        ...
        if (memory_tracker_accuracy_diff_for_test)
            memory_tracker.setAccuracyDiff(memory_tracker_accuracy_diff_for_test);
    }
